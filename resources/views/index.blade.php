...
<body>
    ...
    <header class="text-white bg-stream-dark font-poppins select-none h-full relative">
        ...
        <section class="brands pb-[100px] pt-[50px] flex flex-wrap justify-center items-center gap-x-[70px] gap-y-10 px-2
            relative">
            <img src="{{ asset ('assets/images/logo-apple-tv.svg')}}" alt="stream" />
            <img src="{{ asset ('assets/images/logo-ipad-apple.svg')}}" alt="stream" />
            <img src="{{ asset ('assets/images/logo-android-wordmark.svg')}}" alt="stream" />
            <img src="{{ asset ('assets/images/logo-youtube-tv.svg')}}" alt="stream" />
        </section>
    </header>
